...
final class Swap {
    ...
    static synchronized <T> Token<T> swapOut(T t) throws IOException {
    ...
    static synchronized <T> T swapIn(Token<T> token) throws IOException, ClassNotFoundException {
    ...
    static synchronized void free(Token<?> token) throws IOException {
        SwapDirectory.free(token);
    }
